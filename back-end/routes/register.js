...
router.post('/', async (req, res) => {
  ...
  try {
    ...
    const emailHTML = `
        ...
        <p><strong>Below are your registration details:</strong></p>
        ...
        <p>
        We look forward to welcoming you on the day of the event.
        Please carry this confirmation for verification.
        </p>

        <p>
        For any queries, feel free to contact our coordinators.
        </p>
